    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fees_in_world', models.PositiveSmallIntegerField(default=0, help_text='указывать сумму в долларах', verbose_name='Сборы в США')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.RatinStar', verbose_name='звезда')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descrtption', models.TextField(verbose_name='Описание')),
                ('image', models.ImageField(upload_to='movie shots/', verbose_name='Изображение')),
